...
const cloudevent_to_background_event_1 = require("./middleware/cloudevent_to_background_event");
const background_event_to_cloudevent_1 = require("./middleware/background_event_to_cloudevent");
/**
...
function getServer(userFunction, functionSignatureType) {
    ...
    if (functionSignatureType === types_1.SignatureType.EVENT) {
        app.use(cloudevent_to_background_event_1.cloudeventToBackgroundEventMiddleware);
    }
    if (functionSignatureType === types_1.SignatureType.CLOUDEVENT) {
        app.use(background_event_to_cloudevent_1.backgroundEventToCloudEventMiddleware);
    }
